...
set rc [catch {
  ...
  set_property ip_repo_paths {{d:/ALL PROGRAMMING LANGUAGES/VERLIOG/fa1/fa1.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/ALL PROGRAMMING LANGUAGES/VERLIOG/fa1/fa1.cache/ip}} [current_project]
  add_files -quiet {{D:/ALL PROGRAMMING LANGUAGES/VERLIOG/fa1/fa1.runs/synth_1/fa.dcp}}
  link_design -top fa -part xc7z010clg400-1
...
set rc [catch {
  ...
  report_power -file fa_power_routed.rpt -pb fa_power_summary_routed.pb
