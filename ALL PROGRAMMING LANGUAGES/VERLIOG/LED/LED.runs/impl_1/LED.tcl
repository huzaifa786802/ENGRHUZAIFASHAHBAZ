...
set rc [catch {
  ...
  set_property webtalk.parent_dir {D:/ALL PROGRAMMING LANGUAGES/VERLIOG/LED/LED.cache/wt} [current_project]
  set_property parent.project_path {D:/ALL PROGRAMMING LANGUAGES/VERLIOG/LED/LED.xpr} [current_project]
  set_property ip_repo_paths {{d:/ALL PROGRAMMING LANGUAGES/VERLIOG/LED/LED.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/ALL PROGRAMMING LANGUAGES/VERLIOG/LED/LED.cache/ip}} [current_project]
  add_files -quiet {{D:/ALL PROGRAMMING LANGUAGES/VERLIOG/LED/LED.runs/synth_1/LED.dcp}}
  read_xdc C:/Users/Nobel/Downloads/Zybo-Master.xdc
