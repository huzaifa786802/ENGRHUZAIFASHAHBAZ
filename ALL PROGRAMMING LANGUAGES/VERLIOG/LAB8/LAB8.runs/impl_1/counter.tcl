...
set rc [catch {
  ...
  set_property webtalk.parent_dir {D:/ALL PROGRAMMING LANGUAGES/VERLIOG/LAB8/LAB8.cache/wt} [current_project]
  set_property parent.project_path {D:/ALL PROGRAMMING LANGUAGES/VERLIOG/LAB8/LAB8.xpr} [current_project]
  set_property ip_repo_paths {{d:/ALL PROGRAMMING LANGUAGES/VERLIOG/LAB8/LAB8.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/ALL PROGRAMMING LANGUAGES/VERLIOG/LAB8/LAB8.cache/ip}} [current_project]
  add_files -quiet {{D:/ALL PROGRAMMING LANGUAGES/VERLIOG/LAB8/LAB8.runs/synth_1/counter.dcp}}
